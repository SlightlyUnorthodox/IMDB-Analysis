...
The unique genre classes were then found by performing a pruning of the initial genre data.
```{r, eval=TRUE,warning=FALSE,message=FALSE,cache=TRUE}
...
This resulted in 29 unique genre classes and therefore, 29 clusters to use in analysis.
...
-- Insert other analysis of kCluster output --
