...
```{r eval=FALSE,echo=TRUE,warning=FALSE,message=FALSE,cache=TRUE}
# Prepare example set
stats <- jsonToCsv()
...
```{r eval=FALSE}
lhs                                               rhs                                             
3  {Actor2=John Murray}                           => {Actor1=Dewey 'Pigmeat' Markham}             0.000179501 5571
6  {Cinematographer=['Campos, Ant\\xc3\\xb4nio']} => {Director=Antônio Campos}                   0.000179501 5571
9  {Director=Lionel Soukaz}                       => {Cinematographer=['Soukaz, Lionel']}         0.000179501 5571
12 {Director=John Randolph Bray}                  => {Writer=John Randolph Bray}                  0.000179501         5571
16 {Writer=Miodrag Jovanovic}                     => {Director=Miodrag Jovanovic}                 0.000179501          5571
21 {Director=Karel Zeman}                         => {Writer=Karel Zeman (screenplay)}            0.000179501          5571
23 {Director=Branko Segovic}                      => {Writer=Stanoje Makivic, Branko Segovic}     0.000179501         5571
25 {Director=Branko Segovic}                      => {Cinematographer=['Pavlovic, Mihailo']}      0.000179501         5571
27 {Writer=Stanoje Makivic, Branko Segovic}       => {Cinematographer=['Pavlovic, Mihailo']}      0.000179501          5571
30 {Director=Henry 'Hy' Mayer}                    => {Writer=Henry 'Hy' Mayer}                    0.000179501          5571
34 {Cinematographer=['Oberti, Ralf']}             => {Writer=Ralf Oberti, Rodolfo Paredes}        0.000179501         5571
36 {Cinematographer=['Oberti, Ralf']}             => {Director=Jorge López, Ralf Oberti}         0.000179501        5571
38 {Writer=Ralf Oberti, Rodolfo Paredes}          => {Director=Jorge López, Ralf Oberti}         0.000179501          5571
40 {Cinematographer=['Paul, Robert W.']}          => {Director=Robert W. Paul}                    0.000179501         5571
48 {Director=Scott Eldridge}                      => {Producer=['Eldridge, Scott', 'Fried, Joe']} 0.000179501        5571
50 {Cinematographer=['Yamazaki, Rima']}           => {Director=Rima Yamazaki}                     0.000179501         5571
55 {Director=Daniel Szczechura}                   => {Writer=Daniel Szczechura}                   0.000179501          5571
57 {Director=Daniel Szczechura}                   => {Cinematographer=['Fedak, Waclaw']}          0.000179501          5571
59 {Writer=Milutin Kosovac}                       => {Director=Milutin Kosovac}                   0.000179501          5571
61 {Writer=Daniel Szczechura}                     => {Cinematographer=['Fedak, Waclaw']}          0.000179501          55710
```
...
The full code base can be found at [https://github.com/SlightlyUnorthodox/IMDB-Analysis](IMDB-Analysis)

Individual member contributions can be evaluated at 
[https://github.com/SlightlyUnorthodox/IMDB-Analysis/graphs/contributors](IMDB-Analysis/Contributors)
